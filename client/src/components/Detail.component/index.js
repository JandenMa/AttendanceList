        ...
        return (
            ...
            >
                <Paper className="detail_dialog_paper" elevation={1}>
                    <TextField
                        onInput={this.handleFirstNameInput} value={this.state.title}
                        label="First Name" margin="normal"
                        variant="outlined" fullWidth required
                    />
                    <TextField
                        onInput={this.handleLastNameInput} value={this.state.content}
                        label="Last Name" margin="normal"
                        variant="outlined" fullWidth required
                    />
                    <TextField
                        onInput={this.handleEmailInput} value={this.state.introduction}
                        label="Email" margin="normal" type="email"
                        variant="outlined" fullWidth
                    />
                    <Toolbar>
                        <Button color="primary" variant="outlined"
                            className="detail_dialog_submit" onClick={this.handleSubmit}>
                            <Typography variant="button" color="primary">Submit</Typography>
                        </Button>
                    </Toolbar>
                </Paper>
                <Snackbar
